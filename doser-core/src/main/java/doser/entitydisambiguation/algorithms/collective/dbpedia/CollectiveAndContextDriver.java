...
public class CollectiveAndContextDriver {
	...
	public CollectiveAndContextDriver(Response[] res, List<SurfaceForm> rep, EntityCentricKBDBpedia eckb, String topic) {
		super();
	...
	public void solve() {
		...
		CandidateReductionW2V w2vreduction = new CandidateReductionW2V(eckb, rep, 20, 5, 125, false, false);
		w2vreduction.solve();
		rep = w2vreduction.getRep();

		w2vreduction = new CandidateReductionW2V(eckb, rep, 45, 5, 250, true, true);
		w2vreduction.solve();
		rep = w2vreduction.getRep();
