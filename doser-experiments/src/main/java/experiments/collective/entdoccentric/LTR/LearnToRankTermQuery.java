...
public class LearnToRankTermQuery extends Query {
	...
	final class TermWeight extends Weight {
		...
		public TermWeight(IndexSearcher searcher, TermContext termStates)
			...
			this.stats = sim.computeWeight(getBoost(),
		...
		public Scorer scorer(AtomicReaderContext context,
			...
			assert docs != null;
			return new LearnToRankTermScorer(this, docs, sim.exactSimScorer(
					stats, context), termsEnum.docFreq());
		}
	...
	public LearnToRankTermQuery(Term t, Similarity sim) {
		this(t, -1, sim);
		this.sim = sim;
	}
	 ...
	 */
	public LearnToRankTermQuery(Term t, int docFreq, Similarity sim) {
		term = t;
	 ...
	 * of looking up the docFreq against the searcher.
	 */
	public LearnToRankTermQuery(Term t, TermContext states, Similarity sim) {
		assert states != null;
		term = t;
	...
	public boolean equals(Object o) {
		if (!(o instanceof LearnToRankTermQuery))
			return false;
		LearnToRankTermQuery other = (LearnToRankTermQuery) o;
