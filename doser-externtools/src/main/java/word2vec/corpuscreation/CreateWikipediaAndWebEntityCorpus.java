...
public class CreateWikipediaAndWebEntityCorpus {
	public static final String WIKICORPUSFILE = "/home/zwicklbauer/word2vec/corpus/wikiandwebentitycorpus.dat";
	public static final String WEBCORPUSDIRECTORY = "/home/zwicklbauer/WikipediaEntities/EntitiesWebContext/";

	public static final String DIRECTORY = "/mnt/storage/zwicklbauer/WikiParse/temp/plain_reduced";

	public CreateWikipediaAndWebEntityCorpus() {
		super();
	}

	public void createCorpus() throws FileNotFoundException {
		PrintWriter writer = new PrintWriter(new File(WIKICORPUSFILE));

		File directory = new File(WEBCORPUSDIRECTORY);
	...
	public static void main(String[] args) {
		CreateWikipediaAndWebEntityCorpus corpus = new CreateWikipediaAndWebEntityCorpus();
		try {
			corpus.createCorpus();
		} catch (FileNotFoundException e) {
			e.printStackTrace();
