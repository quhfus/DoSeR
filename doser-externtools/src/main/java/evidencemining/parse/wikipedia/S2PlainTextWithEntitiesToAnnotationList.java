...
import evidencemining.parse.wikipedia.S2PlainTextWithEntitiesToAnnotationList.Handler.Entry;
import evidencemining.parse.wikipedia.S2PlainTextWithEntitiesToAnnotationList.Handler.Entry.Entity;

public class S2PlainTextWithEntitiesToAnnotationList {

	public static int CHARSTOMOVE = 1000;

	public static void main(String[] args) {
		S2PlainTextWithEntitiesToAnnotationList p = new S2PlainTextWithEntitiesToAnnotationList();
		try {
	...
	public S2PlainTextWithEntitiesToAnnotationList() {
		super();
	}

	public void doAction(String maindir, String outputfile) throws FileNotFoundException, IOException {
	...
	private void printObject(PrintWriter writer, Entry entry, Gson gson) {
		...
		for (Entity e : l) {
			...
			try {
				...
				out.setUrl(e.getLink().replaceAll(".html", ""));
